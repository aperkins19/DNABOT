...
if 'tube-rack_E1415-15003' not in labware.list():
    custom_plate = labware.create('tube-rack_E1415-15003', grid=(6, 4), spacing=(20, 20), diameter=12, depth=35, volume=1500)
    robot.comment('tube-rack_E1415-15003 added to labware database')
else:
    robot.comment('tube-rack_E1415-15003 already exists in the OT2 database and has not been updated. Refer to Opentrons API and Custom_labware.csv')
